...
(function () {
    (function (e, t, n) {
        var r, i, s;
        s = "slidesjs";
        i = {width: 940, height: 528, start: 1, navigation: {active: !0, effect: "fade"}, pagination: {active: !1, effect: "fade"}, play: {active: !1, effect: "fade", interval: 5e3, auto: !0, swap: !0, pauseOnHover: !0, restartDelay: 2500}, effect: {slide: {speed: 500}, fade: {speed: 700, crossfade: !1}}, callback: {loaded: function () {
                }, start: function () {
                }, complete: function () {
                }}};
        r = function () {
        ...
        r.prototype.init = function () {
            ...
            e(".slidesjs-control", n).children().addClass("slidesjs-slide").css({position: "relative", top: 0, right: 0, width: "auto", zIndex: 0, display: "none", webkitBackfaceVisibility: "hidden"});
